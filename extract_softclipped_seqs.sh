...
do
  ...
  srun -n1 -N1 shifter samtools view -L subtelomere_starts_1_5000.bed -b $f > soft_clipped_ends/$bam_output_filename
  srun -n1 -N1 ~/SE-MEI/extractSoftclipped soft_clipped_ends/$bam_output_filename > soft_clipped_ends/$fq_output_filename
done
