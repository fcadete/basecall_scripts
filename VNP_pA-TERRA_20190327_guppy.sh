...
#
#srun -n1 -N1 --exclusive shifter bash -c "samtools sort -@ 32 alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_mapont.sam | samtools view -bq 30 - > alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_mapont_q30.bam; samtools index alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_mapont_q30.bam"
#srun -n1 -N1 --exclusive shifter bash -c "samtools sort -@ 32 alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_splice.sam | samtools view -bq 30 - > alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_splice_q30.bam; samtools index alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_splice_q30.bam"
#srun -n1 -N1 --exclusive shifter bash -c "samtools sort -@ 32 alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_mapont.sam | samtools view -bq 30 - > alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_mapont_q30.bam; samtools index alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_mapont_q30.bam"
#srun -n1 -N1 --exclusive shifter bash -c "samtools sort -@ 32 alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_splice.sam | samtools view -bq 30 - > alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_splice_q30.bam; samtools index alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_splice_q30.bam"
#
#
#srun -n1 -N1 --exclusive shifter bash -c "samtools sort -@ 32 alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_mapont.sam | samtools view -bF 256 - > alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_mapont_primary.bam; samtools index alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_mapont_primary.bam"
#srun -n1 -N1 --exclusive shifter bash -c "samtools sort -@ 32 alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_splice.sam | samtools view -bF 256 - > alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_splice_primary.bam; samtools index alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_rhietman_splice_primary.bam"
#srun -n1 -N1 --exclusive shifter bash -c "samtools sort -@ 32 alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_mapont.sam | samtools view -bF 256 - > alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_mapont_primary.bam; samtools index alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_mapont_primary.bam"
#srun -n1 -N1 --exclusive shifter bash -c "samtools sort -@ 32 alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_splice.sam | samtools view -bF 256 - > alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_splice_primary.bam; samtools index alignment_outputs/VNP_pA-TERRA_20190327_${barcode}_on_GRCh38_splice_primary.bam"
#
#
#
#done
...
srun -n1 -N1 --exclusive shifter bash -c "cat 20190327_first_run/VNP_polyA-TERRA/VNP_pA-TERRA_20190327/20190327_1801_MN29796_FAK43621_7641ca36/fastq_guppy/barcode_separated/*fastq |
                                          ...
                                          /minimap2/minimap2 -a -x map-ont -t 32 \
                                              references/ConcatenatedFASTAAassemblies_hTel.txt - > alignment_outputs/VNP_pA-TERRA_20190327_maps_only_to_riethman_assembly.sam &&
                                          samtools sort -@ 32 alignment_outputs/VNP_pA-TERRA_20190327_maps_only_to_riethman_assembly.sam | samtools view -bq 30 - | samtools depth - > alignment_outputs/VNP_pA-TERRA_20190327_maps_only_to_riethman_assembly_q30.depth"
