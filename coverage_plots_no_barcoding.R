...
png("coverage_plots_no_barcoding/coverage_pooled_U2OS.png", width = 1280, height = 1024)
...
png("coverage_plots_no_barcoding/coverage_pooled_HeLa.png", width = 1280, height = 1024)
...
png("coverage_plots_no_barcoding/coverage_pooled_U2OS_zoomed.png", width = 1280, height = 1024)
...
png("coverage_plots_no_barcoding/coverage_pooled_HeLa_zoomed.png", width = 1280, height = 1024)
...
png("coverage_plots_no_barcoding/coverage_pooled_U2OS_extra_zoomed.png", width = 1280, height = 1024)
...
png("coverage_plots_no_barcoding/coverage_pooled_HeLa_extra_zoomed.png", width = 1280, height = 1024)
...
png("coverage_plots_no_barcoding/coverage_pooled_U2OS_extra_zoomed_rajikas_targets.png", width = 1280, height = 1024)
...
png("coverage_plots_no_barcoding/coverage_pooled_HeLa_extra_zoomed_rajikas_targets.png", width = 1280, height = 1024)
...
png("coverage_plots_no_barcoding/coverage_pooled_U2OS_extra_zoomed_rajikas_full_match_targets.png", width = 1280, height = 1024)
...
png("coverage_plots_no_barcoding/coverage_pooled_HeLa_extra_zoomed_rajikas_full_match_targets.png", width = 1280, height = 1024)
