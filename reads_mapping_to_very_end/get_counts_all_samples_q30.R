...
HH_bam_files <- paste0("reads_mapping_to_very_end/HeLa-HEK_barcoded/",
                       ...
                       "/Joana_TERRA_VNP_no_PCR_on_rhietman_mapont_q30_very_end.bam")
...
colnames(HU_count_matrix) <- str_remove(HU_bam_files, "on_rhietman_mapont_q30_very_end.bam")
...
write_tsv(count_repeat_frame,
          path = "count_repeat_frame_reads_mapping_very_end_q30.tsv")
